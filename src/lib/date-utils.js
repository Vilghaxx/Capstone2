...
export function formatDateToLocalYearMonthDay(date) {
 ...
 */
export function formatAppointmentDateToYearMonthDay(value) {
...
export function formatYearMonthDayForDisplay(yearMonthDay) {
    if (!yearMonthDay)
        return "—";
