...
export default function LoginView() {
    ...
    return (<div className="relative flex min-h-screen w-full bg-background">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-blue-600 via-sky-600 to-blue-700 p-12 lg:flex">
        ...
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="relative flex items-center gap-3 text-white">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.15 }} className="relative space-y-6 text-white">
      ...
      <div className="flex w-full items-center justify-center bg-gradient-to-br from-blue-50 via-background to-sky-50 p-4 dark:from-blue-950/20 dark:via-background dark:to-sky-950/20 lg:w-1/2">
        <motion.div initial={{ opacity: 0, y: 12, scale: 0.98 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.3, ease: "easeOut" }} className="w-full max-w-[90vw] sm:max-w-md">
          ...
          <Card className="border-border/60 shadow-xl">
            ...
            <CardContent className="flex justify-center p-4 xs:p-6 sm:p-8">
              <GoogleLogin onSuccess={handleGoogleLogin} onError={() => toast.error("Google sign in failed")} size="large" theme="outline"/>
            </CardContent>
          </Card>
        </motion.div>
      </div>
