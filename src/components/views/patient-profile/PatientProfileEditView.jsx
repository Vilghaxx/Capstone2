...
export default function PatientProfileEditView() {
    ...
    if (isError || !patient) {
        return (<EmptyState title="Could not load profile" message="Please try again later." action={<Button onClick={() => navigate("dashboard")}>
        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormField control={form.control} name="dateOfBirth" render={({ field }) => (<FormItem>
              ...
              <div className="flex gap-3 pt-2">
                <Button type="button" variant="outline" onClick={() => navigate("dashboard")} disabled={updateProfile.isPending}>
                  Cancel
                </Button>
